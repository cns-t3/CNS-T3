...
def get_profile_summary(profile:dict):
    response = openAI_client.chat.completions.create(
        model="gpt-3.5-turbo",
        messages=[
            {"role": "system", "content": "Provide a concise 100-word summary using the provided JSON data, excluding the photo and LinkedIn link. Focus on text only and aim for simplicity and clarity in communication"},
        ]
    )
